  ...
  Feature("Developer views/updates profile") {
    ...
    Scenario("TPSD edits profile") {
      ...
      And("I click on submit")
        whenIClickOnTheButtonWithId("submit")  // auto-chosen (score=1.00, RegisterStepsSteps.scala)
    ...
    Scenario("TPSD edits password") {
      ...
      When("I click on the Change password link")
        whenIClickOnTheLink("Change password")  // ⚠️ No step-def match found for: I click on the Change password link
