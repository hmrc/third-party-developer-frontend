...
class QuestionsController @Inject()(
  ...
  private def processQuestion(submissionId: Submission.Id, questionId: Question.Id, answers: Option[ActualAnswer] = None, errors: Option[String] = None)(submitAction: Call)(implicit request: SubmissionApplicationRequest[AnyContent]) = {
