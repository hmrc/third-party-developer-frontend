...
import domain.ApiSubscriptionFields.{SubscriptionFieldDefinition, SubscriptionFieldsPutSuccessResponse, SubscriptionFieldValue}
...
class SubscriptionFieldsServiceSpec extends UnitSpec with ScalaFutures with MockitoSugar {
  ...
  "saveFields" should {
    "save the fields" in new Setup {
      ...
      ).willReturn(Future.successful(SubscriptionFieldsPutSuccessResponse))
