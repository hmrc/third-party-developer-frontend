...
import uk.gov.hmrc.thirdpartydeveloperfrontend.connectors.{ThirdPartyApplicationProductionConnector, ThirdPartyApplicationSandboxConnector, ThirdPartyDeveloperConnector}

trait MockConnectors1 {
