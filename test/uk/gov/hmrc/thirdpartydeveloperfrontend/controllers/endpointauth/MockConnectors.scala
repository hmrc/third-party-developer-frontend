...
trait MockConnectors extends MockitoSugar with ArgumentMatchersSugar {
  ...
  val cmdProductionConnector: ProductionApplicationCommandConnector                        = mock[ProductionApplicationCommandConnector]
  val cmdSandboxConnector: SandboxApplicationCommandConnector                              = mock[SandboxApplicationCommandConnector]
