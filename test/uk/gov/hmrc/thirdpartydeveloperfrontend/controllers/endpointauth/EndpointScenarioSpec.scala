...
abstract class EndpointScenarioSpec extends AsyncHmrcSpec with GuiceOneAppPerSuite with Writeables
  ...
  final def getQueryParameterValues(endpoint: Endpoint): Map[String,String] = {
    endpoint match {
      case Endpoint("GET",  "/developer/applications/:id/change-locked-subscription", _) => Map("name" -> applicationName, "context" -> apiContext.value, "version" -> apiVersion.value, "redirectTo" -> redirectUrl)
      case Endpoint("POST", "/developer/applications/:id/change-locked-subscription", _) => Map("name" -> applicationName, "context" -> apiContext.value, "version" -> apiVersion.value, "redirectTo" -> redirectUrl)
      case Endpoint("GET",  "/developer/applications/:id/change-private-subscription", _) => Map("name" -> applicationName, "context" -> apiContext.value, "version" -> apiVersion.value, "redirectTo" -> redirectUrl)
      case Endpoint("POST", "/developer/applications/:id/change-private-subscription", _) => Map("name" -> applicationName, "context" -> apiContext.value, "version" -> apiVersion.value, "redirectTo" -> redirectUrl)
      ...
      case Endpoint("POST", "/developer/login-mfa", _) => Map("mfaId" -> authAppMfaId.value.toString, "mfaType" -> MfaType.AUTHENTICATOR_APP.toString, "userHasMultipleMfa" -> false.toString)
      ...
      case Endpoint("GET",  "/developer/profile/security-preferences/auth-app/access-code", _) => Map("mfaId" -> authAppMfaId.value.toString, "mfaAction" -> MfaAction.CREATE.toString, "mfaIdForRemoval" -> authAppMfaId.value.toString)
      case Endpoint("POST", "/developer/profile/security-preferences/auth-app/access-code", _) => Map("mfaId" -> authAppMfaId.value.toString, "mfaAction" -> MfaAction.CREATE.toString, "mfaIdForRemoval" -> authAppMfaId.value.toString)
      ...
      case Endpoint("GET",  "/developer/profile/security-preferences/sms/access-code", _) => Map("mfaId" -> smsMfaId.value.toString, "mfaAction" -> MfaAction.CREATE.toString, "mfaIdForRemoval" -> smsMfaId.value.toString)
      case Endpoint("POST", "/developer/profile/security-preferences/sms/access-code", _) => Map("mfaId" -> smsMfaId.value.toString, "mfaAction" -> MfaAction.CREATE.toString, "mfaIdForRemoval" -> authAppMfaId.value.toString)
  ...
  final def getBodyParameterValues(endpoint: Endpoint): Map[String,String] = {
    endpoint match {
      case Endpoint("POST", "/developer/registration", _) => Map("firstname" -> userFirstName, "lastname" -> userLastName, "emailaddress" -> userEmail, "password" -> userPassword, "confirmpassword" -> userPassword)
      ...
      case Endpoint("POST", "/developer/applications/:id/check-your-answers/terms-and-conditions", _) => Map("hasUrl" -> "true", "termsAndConditionsURL" -> "https://example.com/tcs")
      ...
      case Endpoint("POST", "/developer/applications/:id/details/change-privacy-policy-location", _) => Map("privacyPolicyUrl" -> "http://example.com", "isInDesktop" -> "false", "isNewJourney" -> "true")
      case Endpoint("POST", "/developer/applications/:id/details/change-terms-conditions-location", _) => Map("termsAndConditionsUrl" -> "http://example.com", "isInDesktop" -> "false", "isNewJourney" -> "true")
      ...
      case Endpoint("POST", "/developer/applications/:id/redirect-uris/change-confirmation", _) => Map("originalRedirectUri" -> redirectUrl, "newRedirectUri" -> (redirectUrl + "-new"))
      ...
      case Endpoint("POST", "/developer/applications/:id/responsible-individual/change/other", _) => Map("name" -> (responsibleIndividual.fullName.value + " new"), "email" -> ("new" + responsibleIndividual.emailAddress.value))
      ...
      case Endpoint("POST", "/developer/applications/:id/api-metadata/:context/:version/fields/:fieldName/:saveSubsFieldsPageMode", _) => Map(apiFieldName.value -> apiFieldValue.value)
      ...
      case Endpoint("POST", "/developer/applications/:id/details/change", _) => Map("applicationId" -> applicationId.value, "applicationName" -> applicationName, "description" -> "my description", "privacyPolicyUrl" -> privacyPolicyUrl, "termsAndConditionsUrl" -> termsConditionsUrl, "grantLength" -> "1")
      ...
      case Endpoint("POST", "/developer/profile/password", _) => Map("currentpassword" -> userPassword, "password" -> (userPassword + "new"), "confirmpassword" -> (userPassword + "new"))
  ...
  def getEndpointSuccessResponse(endpoint: Endpoint): Response = {
    endpoint match {
      ...
      case Endpoint("POST", "/developer/applications/:id/team-members/add/:addTeamMemberPageMode", _) => Redirect(s"/developer/applications/${applicationId.value}/request-check/team")
      ...
      case Endpoint("POST", "/developer/applications/:id/responsible-individual/change/self-or-other", _) => Redirect(s"/developer/applications/${applicationId.value}/responsible-individual/change/self")
      case Endpoint("POST", "/developer/applications/:id/responsible-individual/change/self", _) => Redirect(s"/developer/applications/${applicationId.value}/responsible-individual/change/self/confirmed")
      case Endpoint("POST", "/developer/applications/:id/responsible-individual/change/other", _) => Redirect(s"/developer/applications/${applicationId.value}/responsible-individual/change/other/requested")
      ...
      case Endpoint("POST", "/developer/applications/:id/add/subscription-configuration/:pageNumber", _) => Redirect(s"/developer/applications/${applicationId.value}/add/subscription-configuration-step/1")
      case Endpoint("GET",  "/developer/applications/:id/add/subscription-configuration-step/:pageNumber", _) => Redirect(s"/developer/applications/${applicationId.value}/request-check")
      case Endpoint("POST", "/developer/applications/:id/api-metadata/:context/:version/:saveSubsFieldsPageMode", _) => Redirect(s"/developer/applications/${applicationId.value}/api-metadata")
      case Endpoint("POST", "/developer/applications/:id/api-metadata/:context/:version/fields/:fieldName/:saveSubsFieldsPageMode", _) => Redirect(s"/developer/applications/${applicationId.value}/api-metadata")
      case Endpoint("POST", "/developer/no-applications", _) => Redirect(s"/developer/no-applications-start")
      case Endpoint("POST", "/developer/applications/:id/confirm-subscriptions", _) => Redirect(s"/developer/submissions/application/${applicationId.value}/production-credentials-checklist")
      ...
      case Endpoint("POST", "/developer/applications/:id/sell-resell-or-distribute-your-software", _) => Redirect(s"/developer/applications/${applicationId.value}/confirm-subscriptions")
      ...
      case Endpoint("POST", "/developer/applications/:id/check-your-answers/terms-and-conditions", _) => Redirect(s"/developer/applications/${applicationId.value}/check-your-answers")
      ...
      case Endpoint("POST", "/developer/profile/email-preferences/no-apis-from-subscriptions", _) => Redirect(s"/developer/profile/email-preferences/topics-from-subscriptions?context=${applicationId.value}")
      ...
      case Endpoint("POST", "/developer/profile/email-preferences/apis-from-subscriptions", _) => Redirect(s"/developer/profile/email-preferences/topics-from-subscriptions?context=${applicationId.value}")
      ...
      case Endpoint("POST", "/developer/submissions/:sid/question/:qid", _) => Redirect(s"/developer/submissions/application/${applicationId.value}/production-credentials-checklist")
      ...
      case Endpoint("POST", "/developer/profile/security-preferences/auth-app/access-code", _) => Redirect(s"/developer/profile/security-preferences/auth-app/name?mfaId=${authAppMfaId.value.toString}")
      ...
      case Endpoint("POST", "/developer/profile/security-preferences/sms/setup", _) => Redirect(s"/developer/profile/security-preferences/sms/access-code?mfaId=${smsMfaId.value.toString}&mfaAction=CREATE")
