...
//     val supportLandingPageView      = app.injector.instanceOf[SupportEnquiryInitialChoiceView]
//     val helpWithUsingAnApiPage          = app.injector.instanceOf[HelpWithUsingAnApiView]
...
//     val underTest = new SupportController(
//       mock[DeskproService],
//       sessionServiceMock,
//       mock[ErrorHandler],
//       mcc,
...
//       val request = FakeRequest()
//         .withFormUrlEncodedBody("initialChoice" -> "account")
//         .withLoggedIn(underTest, implicitly)(sessionId)
//         .withSession(sessionParams: _*)
...
//       val request = FakeRequest()
//         .withFormUrlEncodedBody("initialChoice" -> "application")
//         .withLoggedIn(underTest, implicitly)(sessionId)
//         .withSession(sessionParams: _*)
