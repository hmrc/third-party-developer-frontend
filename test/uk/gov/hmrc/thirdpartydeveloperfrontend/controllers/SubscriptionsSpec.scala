...
//         verify(underTest.subscriptionsService).subscribeToApi(eqTo(app), eqTo(apiIdentifier), *)(*)
...
//         verify(underTest.subscriptionsService).unsubscribeFromApi(eqTo(app), eqTo(apiIdentifier))(*)
//         verify(applicationServiceMock, never).updateCheckInformation(eqTo(app), any[CheckInformation])(*)
//       }
...
//         verify(underTest.subscriptionsService, never).unsubscribeFromApi(eqTo(app), eqTo(apiIdentifier))(*)
//         verify(applicationServiceMock, never).updateCheckInformation(eqTo(app), any[CheckInformation])(*)
//       }
//     }
...
//         verify(underTest.subscriptionsService).isSubscribedToApi(eqTo(app.id), eqTo(apiIdentifier))(*)
//       }
