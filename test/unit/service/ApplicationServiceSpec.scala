...
class ApplicationServiceSpec extends UnitSpec with MockitoSugar with ScalaFutures {
  ...
  "Update" should {
    ...
    "update application" in new Setup {
      val user = Developer("email@example.com", "first", "last", loggedInState = LoggedInState.LOGGED_IN)
  ...
  "Create" should {
    val applicationId = "applicationId"
    val developer = Developer("email@example.com", "first", "last", loggedInState = LoggedInState.LOGGED_IN)
    val developer2 = Developer("username+alias@example.com", "first", "last", loggedInState = LoggedInState.LOGGED_IN)
  ...
  "requestUplift" should {
    ...
    val user = Developer("Firstname", "Lastname", "email@example.com", loggedInState = LoggedInState.LOGGED_IN)
  ...
  "request application deletion" should {
    ...
    val adminRequester = Developer(adminEmail, "firstname", "lastname", loggedInState = LoggedInState.LOGGED_IN)
    val developerEmail = "developer@example.com"
    val developerRequester = Developer(developerEmail, "firstname", "lastname", loggedInState = LoggedInState.LOGGED_IN)
