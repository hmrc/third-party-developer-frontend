...
class ApplicationServiceSpec extends UnitSpec with MockitoSugar with ScalaFutures {
  ...
  "Update" should {
    ...
    "update application" in new Setup {
      val user = Developer("email@example.com", "first", "last")
  ...
  "Create" should {
    val applicationId = "applicationId"
    val developer = Developer("email@example.com", "first", "last")
    val developer2 = Developer("username+alias@example.com", "first", "last")
  ...
  "request application deletion" should {
    ...
    val adminRequester = Developer(adminEmail, "firstname", "lastname")
    val developerEmail = "developer@example.com"
    val developerRequester = Developer(developerEmail, "firstname", "lastname")
