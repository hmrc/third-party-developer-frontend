...
class BreadcrumbsSpec extends UnitSpec with OneServerPerSuite {
  ...
  "breadcrumbs" should {
    "render in the right order" in {
      ...
      val crumbs = Array(Crumb("Another Breadcrumb"), Crumb.application(application), Crumb.viewAllApplications, Crumb.home(ApplicationConfig))
