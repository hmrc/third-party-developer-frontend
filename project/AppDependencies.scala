...
object AppDependencies {
  ...
  lazy val apiDomainVersion       = "1.6.0-SNAPSHOT"
  lazy val appDomainVersion       = "1.6.0-SNAPSHOT"
  lazy val tpdDomainVersion       = "1.3.0-SNAPSHOT"
  private val orgDomainVersion    = "1.9.0-SNAPSHOT"
